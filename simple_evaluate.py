...
def compute_metrics(site, model_path, test_path):
    ...
    model_path = model_path.replace('{site}', site)
    test_path = test_path.replace('{site}', site)
...
#        for i in range(5):
        ...
        results.append([site] + compute_metrics(
            site,
            "/home/anibal.heinsfeld/repos/acerta-abide/data/models/first.valid.mlp-valid.{site}.pkl",
            "/home/anibal.heinsfeld/repos/acerta-abide/data/corr/corr_test_{site}.csv"
        ))
