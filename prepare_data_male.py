...
if __name__ == "__main__":
    ...
    for derivative in derivatives:
        ...
        prepare_data(pheno, fold_idxs, derivatives_data, output='./data/corr/corr_male_cv_{fold}_{datatype}.csv')
        full_data(pheno, derivatives_data, output='./data/corr/corr_male.csv')
